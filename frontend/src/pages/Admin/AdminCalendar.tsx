...
export default function AdminCalendar() {
  ...
  const calendarMessages: Messages = useMemo(() => ({
    next: t('admin.calendar.messages.next'),
    previous: t('admin.calendar.messages.previous'),
    today: t('admin.calendar.messages.today'),
    month: t('admin.calendar.messages.month'),
    week: t('admin.calendar.messages.week'),
    day: t('admin.calendar.messages.day'),
    agenda: t('admin.calendar.messages.agenda'),
  }), [t]);
            ...
            <div className="bg-white rounded-[32px] shadow-2xl w-full max-w-sm overflow-hidden animate-in zoom-in-95 duration-300 border border-white/20">
              ...
              <div className="p-8 pt-4 space-y-6">
                ...
                <div className="pt-4 flex gap-4">
                  ...
                  >
                    {t('admin.calendar.modal.manageBooking')} <ExternalLink className="w-3.5 h-3.5" />
                  </Link>
                </div>
              </div>
            </div>
